...
- **4.2 Routing by structure** — internal AI-96+token → internal ID; format-06 header → ECIA; an element string opening with AI 01 → the trade item number it carries (amended 2026-07-28, DW-70); 8 or 12–14 digits w/ valid check digit → normalized GTIN lookup (GTIN-miss falls through to free-text); else → free-text search (FR36/M1).
